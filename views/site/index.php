    ...
    <div class="body-content">
        ...
        <div class="row">
            <div class="col-lg-4" style="text-align:center;">
                ...
                <p><?= Html::a("<img src='img/site/registration.png' width='200px' height='200px'>", ['/user/sign']);?>
                <br><i><?= Yii::t('site', 'Home_Registration_Description') ?></i></p>
            ...
            <div class="col-lg-4" style="text-align:center;">
                ...
                <p><?= Html::a("<img src='img/site/login.png' width='200px' height='200px'>", ['/user/login']);?>
				<br><i><?= Yii::t('site', 'Home_Login_Description') ?></i></p>
            ...
            <div class="col-lg-4" style="text-align:center;">
                ...
                <p><?= Html::a("<img src='img/site/tutorial.png' width='200px' height='200px'>", ['/site/tutorial']);?>
                <br><i><?= Yii::t('site', 'Home_Tutorial_Description') ?></i></p>
